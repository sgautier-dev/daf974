...
export function Hero() {
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-4xl font-medium tracking-tight text-slate-900 sm:text-5xl md:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-blue-600">
          ...
          <span className="relative">à temps partagé.</span>
        </span>{' '}
      </h1>
      ...
      <div className="mt-10 flex justify-center gap-x-6">
        ...
        {/* <Button href="#faq-title" variant="outline">
          ...
          <span className="ml-3">Voir la FAQ</span>
        </Button> */}
      </div>
