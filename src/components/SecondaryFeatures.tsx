...
import screenshotContacts from '@/images/dga.jpg'
import screenshotInventory from '@/images/lbo.jpg'
import screenshotProfitLoss from '@/images/daf.jpg'
      ...
      {features.map((feature) => (
        <div key={feature.summary}>
          ...
          <div className="relative mt-10 pb-10">
            ...
            <div className="relative mx-auto w-auto overflow-hidden rounded-xl bg-white shadow-lg shadow-slate-900/5 ring-1 ring-slate-500/10">
              <Image
                className="w-full"
                src={feature.image}
                alt=""
